...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.APIKey.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.CreateCustomDomainRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.CreateDestinationRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.CreateRouteRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.CreateSourceRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.ReplayEventData.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.RetryPolicy.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.Route.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.Source.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.StatsDailyItem.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.StatsData.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.StatsStatusItem.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.UpdateDestinationRequest.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new dev.gethook.model.UpsertBrandSettingsRequest.CustomTypeAdapterFactory());
